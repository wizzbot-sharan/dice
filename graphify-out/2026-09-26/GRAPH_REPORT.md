...
Cohesion: 0.05
Nodes (38): createApplyQueue(), claimNextJob(), countActiveQueueItems(), enqueueApplyJob(), recoverStuckJobs(), { createPool }, assertIdentifier(), createPool() (+30 more)
...
- **Why does `createPool()` connect `createPool` to `dashboard-server.js`, `import-operators.js`, `sync-daily-pipeline.js`, `due-work-ticker.js`?**
